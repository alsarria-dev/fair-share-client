...
const UserProfilePage = () => {
  ...
  const { user, avatarPic, storeToken, authenticateUser, logOut } =
    ...
    <div className="user-profile-container">
      ...
      <div className="user-form-column2">
        <form className="user-profile-form">
          ...
          <div>
            <button className="button-userform" onClick={handleSubmit}>
              Save
            </button>
            <button className="button-userform" onClick={logOut}>
              Log Out
            </button>
          </div>
        </form>
        <p
          className={
            messageOutput === "Please fill all the fields"
              ? "message-red"
              : "message-green"
          }
        >
